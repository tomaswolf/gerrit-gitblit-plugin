...
/**
 * Utility class for collecting metrics on a branch, tag, or other ref within the repository.
 * 
 * @author James Moger
 * 
 */
public class MetricUtils {
	...
	/**
	 * Returns the list of metrics for the specified commit reference, branch, or tag within the repository. If includeTotal is true, the total of all
	 * the metrics will be included as the first element in the returned list.
	 * 
	 * If the dateformat is unspecified an attempt is made to determine an appropriate date format by determining the time difference between the
	 * first commit on the branch and the most recent commit. This assumes that the commits are linear.
	 * 
	 * @param repository
	 * @param objectId
