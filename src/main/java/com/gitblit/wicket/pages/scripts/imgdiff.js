...
function setup() {
	$('.imgdiff-container').each(function() {
		...
		if (typeof $img[0].style.mixBlendMode != 'undefined') {
			...
			// and Blending Level 1 spec (http://www.w3.org/TR/compositing-1/ )? As of 2014-11, only
			// Firefox >= 32 and Safari >= 7.1 support this. Other browsers will have to make do with the
			// blink comparator only.
